//Lecture 26.0 Finish register and send emails, Create mailer.js in helpers, npm i googleapis nodemailer
...
//Lecture 26.1 Create sendverificationEmail funtion
...
//Lecture 72.1 copy paste sendVerificationEmail, Pass code
exports.sendResetCode = (email, name, code) => {
  ...
  const mailOptions = {
    from: EMAIL,
    to: email,
    //Lecture 72.2 Subject change
    subject: "Reset facebook password",
    //Lecture 72.2 Change html
